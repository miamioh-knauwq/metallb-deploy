pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/miamioh-knauwq/metallb-deploy'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('knauwq-225')   // <---- Change this to match your kubernetes cluster credentials
    }
